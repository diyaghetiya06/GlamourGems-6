...
if (
    ...
    if ($image_row) {
        ...
        mysqli_query(
            $conn,
            "DELETE FROM collection_kids_products
             WHERE id = $delete_id"
        );
    ...
    header('Location: kids-collection.php?success=deleted');
    exit;
}
...
if (
    ...
    header('Location: kids-collection.php?success=status');
    exit;
}
    ...
    <div class="gg-page-header">
        ...
        <div>
            ...
            <p class="gg-page-subtitle">
                Manage products displayed in the Kids Collection.
            </p>
            ...
            <div class="table-responsive">
                ...
                <table class="table-gg">
                    ...
                    <tbody>
                        ...
                        <?php if ($kids_query && mysqli_num_rows($kids_query) > 0): ?>


                            <?php while ($product = mysqli_fetch_assoc($kids_query)): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        >
                                            ...
                                            <a
                                                href="edit-kids-collection.php?id=<?php echo (int) $product['id']; ?>"
                                                class="btn-gg-gold"
                                            >
                                            ...
                                            <form
                                                method="POST"
                                                style="display:inline;"
                                                onsubmit="return confirm('Are you sure you want to delete this Kids Collection product?');"
                                            >
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    No Kids Collection products found.
