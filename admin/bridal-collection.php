...
if (
    ...
    if ($image_row) {
        ...
        mysqli_query(
            $conn,
            "DELETE FROM collection_bridal_products
             WHERE id = $delete_id"
        );

        $image_path =
            __DIR__ .
            '/../assets/images/bridal/' .
            $image_row['image'];
    ...
    header('Location: bridal-collection.php?success=deleted');
    exit;
}
...
if (
    ...
    mysqli_query(
        $conn,
        "UPDATE collection_bridal_products
         SET status = CASE
    ...
    header('Location: bridal-collection.php?success=status');
    exit;
}
    ...
    <div class="gg-page-header">
        ...
        <div>
            ...
            <p class="gg-page-subtitle">
                Manage products displayed in the Bridal Collection.
            </p>

        </div>

        <a
            href="add-bridal-collection.php"
            class="btn-gg-gold"
        >
            ...
            <div class="table-responsive">
                ...
                <table class="table-gg">
                    ...
                    <tbody>
                        ...
                        <?php if (mysqli_num_rows($bridal_query) > 0): ?>


                            <?php while ($product = mysqli_fetch_assoc($bridal_query)): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img
                                            src="../assets/images/bridal/<?php echo htmlspecialchars($product['image']); ?>"
                                    ...
                                    <td>
                                        ...
                                        >
                                            ...
                                            <a
                                                href="edit-bridal-collection.php?id=<?php echo (int) $product['id']; ?>"
                                                class="btn-gg-gold"
                                            >
                                            ...
                                            <form
                                                method="POST"
                                                style="display:inline;"
                                                onsubmit="return confirm('Are you sure you want to delete this Bridal Collection product?');"
                                            >
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    No Bridal Collection products found.
