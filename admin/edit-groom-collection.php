...
if ($id <= 0) {
    header('Location: groom-collection.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($error === '') {
        ...
        if ($update_query) {
            ...
            header(
                'Location: groom-collection.php?success=updated'
            );
    ...
    <div class="gg-page-header">
        ...
        <div>
            ...
            <p class="gg-page-subtitle">
                Update Groom Collection product details.
            </p>
