...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    if ($image_row) {
        ...
        mysqli_query(
            $conn,
            "DELETE FROM collection_groom_products
             WHERE id = $delete_id"
        );
    ...
    header('Location: groom-collection.php?success=deleted');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['toggle_id'])) {
    ...
    mysqli_query(
        $conn,
        "UPDATE collection_groom_products
         SET status = CASE
    ...
    header('Location: groom-collection.php?success=status');
    exit;
}


/*======================================
        FETCH GROOM PRODUCTS
======================================*/

$groom_query = mysqli_query(
    $conn,
    "SELECT *
     FROM collection_groom_products
    ...
    <div class="gg-page-header">
        ...
        <div>
            ...
            <p class="gg-page-subtitle">
                Manage products displayed in the Groom Collection.
            </p>
            ...
            <div class="table-responsive">
                ...
                <table class="table-gg">
                    ...
                    <tbody>
                        ...
                        <?php if (mysqli_num_rows($groom_query) > 0): ?>


                            <?php while ($product = mysqli_fetch_assoc($groom_query)): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img
                                            src="../assets/images/groom/<?php echo htmlspecialchars($product['image']); ?>"
                                    ...
                                    <td>
                                        ...
                                        >
                                            ...
                                            <a
                                                href="edit-groom-collection.php?id=<?php echo (int) $product['id']; ?>"
                                                class="btn-gg-gold"
                                            >
                                            ...
                                            <form
                                                method="POST"
                                                style="display:inline;"
                                                onsubmit="return confirm('Are you sure you want to delete this Groom Collection product?');"
                                            >
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    No Groom Collection products found.
