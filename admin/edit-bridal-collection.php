...
$page_title = 'Edit Bridal Collection';
...
if ($id <= 0) {
    ...
    header('Location: bridal-collection.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($error === '') {
        ...
        if ($update_query) {
            ...
            header(
                'Location: bridal-collection.php?success=updated'
            );
    ...
    <div class="gg-page-header">
        ...
        <div>
            ...
            <p class="gg-page-subtitle">
                Update Bridal Collection product details.
            </p>
