...
$page_title = 'Add Kids Collection Product';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($error === '') {
        ...
        $insert_query = mysqli_query(
            $conn,
            "INSERT INTO collection_kids_products
            (
                name,
                price,
                image,
        ...
        if ($insert_query) {
            ...
            header(
                'Location: kids-collection.php?success=added'
            );
    ...
    <div class="gg-page-header">
        ...
        <div>
            ...
            <p class="gg-page-subtitle">
                Add a new product to the Kids Collection.
            </p>
