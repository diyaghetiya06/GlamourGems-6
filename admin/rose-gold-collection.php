...
$page_title = 'Rose Gold Collection';
...
if (
    ...
    if ($image_row) {
        ...
        mysqli_query(
            $conn,
            "DELETE FROM collection_rose_gold_products
             WHERE id = $delete_id"
        );
    ...
    header('Location: rose-gold-collection.php?success=deleted');
    exit;
}
...
if (
    ...
    header('Location: rose-gold-collection.php?success=status');
    exit;
}


/*======================================
        FETCH ROSE GOLD PRODUCTS
======================================*/

$rose_gold_query = mysqli_query(
    $conn,
    "SELECT *
     FROM collection_rose_gold_products
    ...
    <div class="gg-page-header">
        ...
        <div>
            ...
            <p class="gg-page-subtitle">
                Manage products displayed in the Rose Gold Collection.
            </p>
        ...
        <a
            href="add-rose-gold-collection.php"
            class="btn-gg-gold"
        >
            ...
            <div class="table-responsive">
                ...
                <table class="table-gg">
                    ...
                    <tbody>
                        ...
                        <?php if (
                            $rose_gold_query &&
                            mysqli_num_rows($rose_gold_query) > 0
                        ): ?>

                            <?php while (
                                $product = mysqli_fetch_assoc($rose_gold_query)
                            ): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ">
                                            ...
                                            <a
                                                href="edit-rose-gold-collection.php?id=<?php echo (int) $product['id']; ?>"
                                                class="btn-gg-gold"
                                            >
                                            ...
                                            <form
                                                method="POST"
                                                style="display:inline;"
                                                onsubmit="return confirm('Are you sure you want to delete this Rose Gold Collection product?');"
                                            >
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                >
                                    No Rose Gold Collection products found.
                                </td>
